...
$(document).ready(function(){
    $("#submit_btn").click(function(){
        ...
        if (proceed) {
            //dataResultadosEsperados to be sent to server
            post_data = {
                'userName': user_name,
            ...
            //Ajax post dataResultadosEsperados to server
            $.post('contact_reservations.php', post_data, function(response){
            
                //load json dataResultadosEsperados from server and output message
