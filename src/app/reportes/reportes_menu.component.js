...
var ReportesComponent = (function () {
    ...
    ReportesComponent = __decorate([
        core_1.Component({
            ...
            templateUrl: "./app/reportes/reportes_menu.component.html",
            styles: [
                "\n            .dp\n                {\n                    border:10px solid #eee;\n                    transition: all 0.2s ease-in-out;\n                }\n            .dp:hover\n                {\n                    border:2px solid #eee;\n                    transform:rotate(360deg);\n                    -ms-transform:rotate(360deg);  \n                    -webkit-transform:rotate(360deg);  \n                    /*-webkit-font-smoothing:antialiased;*/\n                }\n            "
            ],
            providers: [reportes_service_1.ReportesService]
        }), 
        __metadata('design:paramtypes', [login_service_1.LoginService, router_1.Router, reportes_service_1.ReportesService])
    ], ReportesComponent);
    return ReportesComponent;
}());
exports.ReportesComponent = ReportesComponent;
//# sourceMappingURL=reportes_menu.component.js.map