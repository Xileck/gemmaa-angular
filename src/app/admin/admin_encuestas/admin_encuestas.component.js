 ...
 */
var AdminEncuestasComponent = (function () {
    ...
    AdminEncuestasComponent = __decorate([
        core_1.Component({
            ...
            templateUrl: "./app/admin/admin_encuestas/admin_encuestas.component.html",
        ...
        __metadata('design:paramtypes', [util_service_1.UtilService, router_1.ActivatedRoute, login_service_1.LoginService, router_1.Router, api_1.ConfirmationService, encuesta_service_1.EncuestaService])
    ], AdminEncuestasComponent);
    return AdminEncuestasComponent;
}());
exports.AdminEncuestasComponent = AdminEncuestasComponent;
//# sourceMappingURL=admin_encuestas.component.js.map