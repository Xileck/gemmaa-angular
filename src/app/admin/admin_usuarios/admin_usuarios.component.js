...
var AdminUsuariosComponent = (function () {
    ...
    AdminUsuariosComponent.prototype.selectUsuario = function (event, usr, overlaypanel) {
        this.selectedUser = new Usuario_1.Usuario();
    ...
    AdminUsuariosComponent = __decorate([
        core_1.Component({
            ...
            templateUrl: "app/admin/admin_usuarios/admin_usuarios.component.html",
            styleUrls: ["app/admin/admin_usuarios/admin_usuarios.component.css"],
            providers: [api_1.ConfirmationService]
        }), 
        __metadata('design:paramtypes', [seguridad_service_1.SeguridadService, login_service_1.LoginService, api_1.ConfirmationService, router_1.Router, util_service_1.UtilService, administracion_service_1.AdminService])
    ], AdminUsuariosComponent);
    return AdminUsuariosComponent;
}());
exports.AdminUsuariosComponent = AdminUsuariosComponent;
//# sourceMappingURL=admin_usuarios.component.js.map